...
// attaching to figure I_BLOCK state_1
START_TEST(test_1) {
  ...
  for (int j = 0; j < 9; j++) game_info.field[7][j] = 1;
  ...
  ck_assert_msg(figure.y_pos == 6, "figure.y_pos failed");
...
// attaching to figure I_BLOCK state_2
START_TEST(test_2) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
  ...
  for (int j = 0; j < 9; j++) game_info.field[9][j] = 1;
...
// attaching to figure I_BLOCK state_3
START_TEST(test_3) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
  ...
  for (int j = 0; j < 9; j++) game_info.field[8][j] = 1;
...
// attaching to figure I_BLOCK state_4
START_TEST(test_4) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure J_BLOCK state_1
START_TEST(test_5) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure J_BLOCK state_2
START_TEST(test_6) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure J_BLOCK state_3
START_TEST(test_7) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure J_BLOCK state_4
START_TEST(test_8) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure L_BLOCK state_1
START_TEST(test_9) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure L_BLOCK state_2
START_TEST(test_10) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure L_BLOCK state_3
START_TEST(test_11) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure L_BLOCK state_4
START_TEST(test_12) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure O_BLOCK state_1
START_TEST(test_13) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure O_BLOCK state_2
START_TEST(test_14) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure O_BLOCK state_3
START_TEST(test_15) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure O_BLOCK state_4
START_TEST(test_16) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure S_BLOCK state_1
START_TEST(test_17) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure S_BLOCK state_2
START_TEST(test_18) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure T_BLOCK state_1
START_TEST(test_21) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure T_BLOCK state_2
START_TEST(test_22) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure T_BLOCK state_3
START_TEST(test_23) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure T_BLOCK state_4
START_TEST(test_24) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// attaching to figure Z_BLOCK state_2
START_TEST(test_26) {
  UserAction_t user_action = Down;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
Suite *test_attaching_figure(void) {
  Suite *suite = suite_create("test_attaching_figure");
  TCase *tcase_core = tcase_create("test_attaching_figure");
