...
// shift move right I_BLOCK state_1
START_TEST(test_1) {
  ...
  ck_assert_msg(g_state == SHIFTING, "g_state failed");
  ck_assert_msg(figure.x_pos == 6, "figure.x_pos failed");
...
// shift move right I_BLOCK state_2
START_TEST(test_2) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
  ...
  ck_assert_msg(g_state == SHIFTING, "g_state failed");
  ck_assert_msg(figure.x_pos == 7, "figure.x_pos failed");
  ck_assert_msg(figure.y_pos == 1, "figure.y_pos failed");
...
// shift move right I_BLOCK state_3
START_TEST(test_3) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right I_BLOCK state_4
START_TEST(test_4) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
  ...
  ck_assert_msg(g_state == SHIFTING, "g_state failed");
  ck_assert_msg(figure.x_pos == 8, "figure.x_pos failed");
  ck_assert_msg(figure.y_pos == 1, "figure.y_pos failed");
...
// shift move right J_BLOCK state_1
START_TEST(test_5) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right J_BLOCK state_2
START_TEST(test_6) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right J_BLOCK state_3
START_TEST(test_7) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right J_BLOCK state_4
START_TEST(test_8) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right L_BLOCK state_1
START_TEST(test_9) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right L_BLOCK state_2
START_TEST(test_10) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right L_BLOCK state_3
START_TEST(test_11) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right L_BLOCK state_4
START_TEST(test_12) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right O_BLOCK state_1
START_TEST(test_13) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right O_BLOCK state_2
START_TEST(test_14) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right O_BLOCK state_3
START_TEST(test_15) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right O_BLOCK state_4
START_TEST(test_16) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right S_BLOCK state_1
START_TEST(test_17) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right S_BLOCK state_2
START_TEST(test_18) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right S_BLOCK state_3
START_TEST(test_19) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right S_BLOCK state_4
START_TEST(test_20) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right T_BLOCK state_1
START_TEST(test_21) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right T_BLOCK state_2
START_TEST(test_22) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right T_BLOCK state_3
START_TEST(test_23) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right T_BLOCK state_4
START_TEST(test_24) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right Z_BLOCK state_1
START_TEST(test_25) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right Z_BLOCK state_2
START_TEST(test_26) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right Z_BLOCK state_3
START_TEST(test_27) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move right Z_BLOCK state_4
START_TEST(test_28) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right I_BLOCK state_1
START_TEST(test_29) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
  ...
  for (int i = 0; i < 20; i++) game_info.field[i][7] = 1;
  ...
  ck_assert_msg(figure.state == state_1, "figure.state failed");
  ck_assert_msg(g_state == SHIFTING, "g_state failed");
  ck_assert_msg(figure.x_pos == 6 - 3, "figure.x_pos failed");
  ck_assert_msg(figure.y_pos == 1, "figure.y_pos failed");
...
// shift move to figure right I_BLOCK state_2
START_TEST(test_30) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
  ...
  ck_assert_msg(figure.state == state_2, "figure.state failed");
  ck_assert_msg(g_state == SHIFTING, "g_state failed");
  ck_assert_msg(figure.x_pos == 4, "figure.x_pos failed");
  ck_assert_msg(figure.y_pos == 1, "figure.y_pos failed");
...
// shift move to figure right I_BLOCK state_3
START_TEST(test_31) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right I_BLOCK state_4
START_TEST(test_32) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
  ...
  ck_assert_msg(figure.state == state_4, "figure.state failed");
  ck_assert_msg(g_state == SHIFTING, "g_state failed");
  ck_assert_msg(figure.x_pos == 8 - 3, "figure.x_pos failed");
  ck_assert_msg(figure.y_pos == 1, "figure.y_pos failed");
...
// shift move to figure right J_BLOCK state_1
START_TEST(test_33) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
  ...
  ck_assert_msg(figure.state == state_1, "figure.state failed");
  ck_assert_msg(g_state == SHIFTING, "g_state failed");
  ck_assert_msg(figure.x_pos == 7 - 3, "figure.x_pos failed");
  ck_assert_msg(figure.y_pos == 1, "figure.y_pos failed");
...
// shift move to figure right J_BLOCK state_2
START_TEST(test_34) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right J_BLOCK state_3
START_TEST(test_35) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right J_BLOCK state_4
START_TEST(test_36) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right L_BLOCK state_1
START_TEST(test_37) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right L_BLOCK state_2
START_TEST(test_38) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right L_BLOCK state_3
START_TEST(test_39) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right L_BLOCK state_4
START_TEST(test_40) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right O_BLOCK state_1
START_TEST(test_41) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right O_BLOCK state_2
START_TEST(test_42) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right O_BLOCK state_3
START_TEST(test_43) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right O_BLOCK state_4
START_TEST(test_44) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right S_BLOCK state_1
START_TEST(test_45) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right S_BLOCK state_2
START_TEST(test_46) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right S_BLOCK state_3
START_TEST(test_47) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right S_BLOCK state_4
START_TEST(test_48) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right T_BLOCK state_1
START_TEST(test_49) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right T_BLOCK state_2
START_TEST(test_50) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right T_BLOCK state_3
START_TEST(test_51) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right T_BLOCK state_4
START_TEST(test_52) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right Z_BLOCK state_1
START_TEST(test_53) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right Z_BLOCK state_2
START_TEST(test_54) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right Z_BLOCK state_3
START_TEST(test_55) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
// shift move to figure right Z_BLOCK state_4
START_TEST(test_56) {
  UserAction_t user_action = Right;
  GameInfo_t game_info;
  game_info_init(&game_info);
...
Suite *test_move_right_shift(void) {
  Suite *suite = suite_create("test_move_right_shift");
  TCase *tcase_core = tcase_create("test_move_right_shift");
  ...
  tcase_add_test(tcase_core, test_55);
  tcase_add_test(tcase_core, test_56);
